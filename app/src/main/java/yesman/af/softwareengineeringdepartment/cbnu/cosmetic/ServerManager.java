...
import yesman.af.softwareengineeringdepartment.cbnu.cosmetic.DBStaticValue.COSMETIC;
import yesman.af.softwareengineeringdepartment.cbnu.cosmetic.DBStaticValue.RANKING;
import yesman.af.softwareengineeringdepartment.cbnu.cosmetic.DBStaticValue.REVIEW;

/**
 * Created by seokhyeon on 2016-12-05.
 */
public class ServerManager {
    ...
    public void get_cosmetic_data(){
        get_cosmetic_Async async = new get_cosmetic_Async();
        async.execute(url+"getall_cosmetic_info");
    }

    public void store_review(Review review){
    ...
    public void modify_reveiw(Review review){
        JSONMaker.getInstance().makeJson_store_review(review.getCosmetic_brand_name(), review.getCosmetic_name(), review.getReview_name(), review.getReview_content(), review.getCosmetic_duration(), review.getCosmetic_Rank(), review.getComestic_id());
        store_review_async async = new store_review_async();
    ...
    public void get_rank_cosmetic_info(){
        get_rank_cosmetic_Async async = new get_rank_cosmetic_Async();
        async.execute(url+"get_rank_cosmetic_info");
    }
                ...
                for(int i=0;i<jarr.length();i++){
                    ...
                    if(!reviews_string.equals("{}")){
                        ...
                        for(int j=0;j<review_arr.length();j++){
                            ...
                            c_reviews[j] = new Review(review_b_name,review_c_name,reviewer_id,content,duration,review_rank,review_cos_id);
