...
public class Review {
    ...
    public Review(String cosmetic_brand_name, String comestic_name, String review_name, String review_content, int cometic_duration, double cometic_Rank, int comestic_id){
        this.comestic_id = comestic_id;
        this.cosmetic_brand_name = cosmetic_brand_name;
        this.review_name = review_name;
        this.review_content = review_content;
